...
* Now
- [-] substring matching
  - [ ] think it would be good as a separate feature (resolve or match)
  - [X] substring function
  - [X] filter function
  - [ ] Get text in current line and pass to filter function
  - [ ] pass the args from teh config
  - [ ]
  - [ ] Get filter results and populate autocomplete
  - [ ] What do i do with already entered text? Maybe just leave it and let user select it
  - [ ] Create mapping for it
    + [ ] could be enter again?
